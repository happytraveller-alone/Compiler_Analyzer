...
int leftSmall = 0; // 左括号的个数
int rightSmall = 0; // 右括号的个数
int leftMiddle = 0; // 左中括号的个数
int rightMiddle = 0; // 右中括号的个数
int leftBig = 0; // 左大括号的个数
int rightBig = 0; // 右大括号的个数
...
void printNode2()
{
    ...
    while (p != NULL)
    {
        ...
        {
            filecifa << setw(10) << p->content << setw(10) << "<" << p->content << ",_>" << endl;
        }
...
void printNodeLink()
{
    ...
    p = p->next;
    Nodelink << "***********************词法分析表************************" << endl;
    Nodelink << setw(8) << "内容" << setw(10) << "描述" << setw(11) << "种别码" << setw(10) << "地址" << setw(8) << "行号" << endl;
    while (p != NULL)
    {
        if (p->type == IDN)
        {
            Nodelink << setw(8) << p->content << setw(10) << p->describe << setw(10) << p->type << setw(8) << p->addr << setw(7) << p->line
                     << endl;
        }
        else
        {
            Nodelink << setw(8) << p->content << setw(10) << p->describe << setw(10) << p->type << setw(15) << p->line << endl;
        }
        p = p->next;
    }
    Nodelink << endl;
...
void printErrorLink()
{
    ...
    p = p->next;
    Errorlink << "***********************错误表************************" << endl;
    Errorlink << setw(8) << "内容" << setw(10) << "描述" << setw(8) << "类型" << setw(8) << "行号" << endl;
    while (p != NULL)
    {
        Errorlink << setw(8) << p->content << setw(10) << p->describe << setw(8) << p->type << setw(7) << p->line << endl;
        p = p->next;
    }
    cout << endl;
    Errorlink.close();
...
void printIdentLink()
{
    ...
    p = p->next;
    IdentLink << "***********************符号表************************" << endl;
    IdentLink << setw(8) << "内容" << setw(10) << "描述" << setw(11) << "种别码" << setw(10) << "地址" << setw(8) << "行号" << endl;
    while (p != NULL)
    {
        IdentLink << setw(8) << p->content << setw(10) << p->describe << setw(10) << p->type << setw(15) << p->line << endl;
        p = p->next;
    }
    IdentLink << endl;
}
